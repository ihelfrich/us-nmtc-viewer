...
CLAIMS: list[tuple] = [
    ...
    ("00-abstract", "1.19$\\times$ metro", "summary_by_metro.csv",
     "rows", lambda v: next(r["leverage_median"] for r in v
                            if r["metro"] == "metro")),
    ("00-abstract", "raw gap is a precise\n$-0.262$", "referee_fixes.json",
     "F1_gelbach.beta_M0", lambda v: v),
    ("00-abstract", "mean within-CDE estimate is\n$-0.047$", "referee_fixes.json",
     "F1_gelbach.beta_full", lambda v: v),
    ("00-abstract", "median-regression analog\nis $-0.001$", "referee_fixes.json",
     "F3_power.median_beta", lambda v: v),
    ("00-abstract", "Gelbach decomposition, $-0.185$", "referee_fixes.json",
     "F1_gelbach.contrib_cde", lambda v: v),
    ("00-abstract", "raw gap, 86\\% of the\nexplained movement", "referee_fixes.json",
    ...
    ("01-intro", "leverage is $-0.262$", "referee_fixes.json",
     "F1_gelbach.beta_M0", lambda v: v),
    ("01-intro", "fixed effects\nmove it to $-0.172$", "review_round2.json",
    ...
    ("01-intro", "point estimate falls to\n$-0.047$", "referee_fixes.json",
     "F1_gelbach.beta_full", lambda v: v),
    ...
    ("01-intro", "larger than $0.21$", "referee_fixes.json",
     "F3_power.mean_rejectable_penalty", lambda v: v),
    ("01-intro", "within-CDE penalty is\n$-0.001$", "referee_fixes.json",
     "F3_power.median_beta", lambda v: v),
    ("01-intro", "(SE $0.008$)", "referee_fixes.json",
     "F3_power.median_se_iid", lambda v: v),

    ("07-conclusion", "decomposition associates $-0.185$", "referee_fixes.json",
     "F1_gelbach.contrib_cde", lambda v: v),
    ("07-conclusion", "raw $-0.262$ gap", "referee_fixes.json",
     "F1_gelbach.beta_M0", lambda v: v),
    ("07-conclusion", "effects returns\n$-0.060$", "review_round2.json",
     "G1_specs.M4S_nested.beta", lambda v: v),
